...
public class XueliEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Xueli{" +
            "id=" + id +
            ", yonghuId=" + yonghuId +
            ", zhuanjiediId=" + zhuanjiediId +
            ", xueliUuidNumber=" + xueliUuidNumber +
            ", zhengjianPhoto=" + zhengjianPhoto +
            ", xueliName=" + xueliName +
            ", xueliIdNumber=" + xueliIdNumber +
            ", xueliZhengshuNumber=" + xueliZhengshuNumber +
            ", xueliRenzhengbianhaoNumber=" + xueliRenzhengbianhaoNumber +
            ", xuelixingbieTypes=" + xuelixingbieTypes +
            ", xueliChushengnianyue=" + xueliChushengnianyue +
            ", xueliGuoji=" + xueliGuoji +
            ", xueliMinzu=" + xueliMinzu +
            ", xuelixingzhiTypes=" + xuelixingzhiTypes +
            ", xueliXuezhiTypes=" + xueliXuezhiTypes +
            ", xueliXuexixingshiTypes=" + xueliXuexixingshiTypes +
            ", xueliBiyeyuanxiao=" + xueliBiyeyuanxiao +
            ", xueliZhuanyeTypes=" + xueliZhuanyeTypes +
            ", xueliBanjiTypes=" + xueliBanjiTypes +
            ", xueliRuxiaonianyue=" + xueliRuxiaonianyue +
            ", xueliBiyenianyue=" + xueliBiyenianyue +
            ", xueliChengfenTypes=" + xueliChengfenTypes +
            ", xueliLianxifangshiPhone=" + xueliLianxifangshiPhone +
            ", xueliYesnoTypes=" + xueliYesnoTypes +
            ", xueliYesnoText=" + xueliYesnoText +
            ", xueliDelete=" + xueliDelete +
