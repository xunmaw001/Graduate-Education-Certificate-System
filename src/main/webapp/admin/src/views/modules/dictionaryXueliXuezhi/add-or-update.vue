<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="学制编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="学制编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="学制编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="学制编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="学制" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="学制" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="学制" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    this.$http({
                        ...
                        method: "post",
                        data: {"dicCode":"xueli_xuezhi_types"}
                    }).then(({ data }) => {
                        if (data && data.code === 0) {
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="xueli_xuezhi_types";
                        ruleForm["dicName"]="学制";
                        this.$http({
